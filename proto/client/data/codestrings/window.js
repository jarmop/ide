...
static void __xdg_wm_base_ping(void *data, struct xdg_wm_base *xdg_wm_base, uint32_t serial) {
...
static void __seat_capabilities(void *data, struct wl_seat *wl_seat, uint32_t new_capabilities) {
    // fprintf(stderr, "received seat capabilities: %d\n", new_capabilities);
    seat = wl_seat;
    capabilities = new_capabilities;
}

 static void __seat_name(void *data, struct wl_seat *wl_seat, const char *name) {
...
static void __registry_handler(void *data, struct wl_registry *registry, uint32_t id, const char *interface, uint32_t version) {
...
static void __xdg_surface_configure(void *data, struct xdg_surface *xdg_surface, uint32_t serial) {
...
static void __xdg_toplevel_configure(void *data, struct xdg_toplevel *toplevel, int32_t width, int32_t height, struct wl_array *states) {
    if (width > 0 && height > 0) {
        new_width = width;
        new_height = height;
    }
...
static void __keyboard_keymap(void *data, struct wl_keyboard *keyboard,	uint32_t format, int32_t fd, uint32_t size) {
...
static void __keyboard_enter(void *data, struct wl_keyboard *wl_keyboard, uint32_t serial, struct wl_surface *surface, struct wl_array *keys) {
    // fprintf(stderr, "__keyboard_enter\n");
}

static void __keyboard_leave(void *data, struct wl_keyboard *wl_keyboard, uint32_t serial, struct wl_surface *surface) {
...
static void __keyboard_key(void *data, struct wl_keyboard *wl_keyboard,	uint32_t serial, uint32_t time,	uint32_t key, uint32_t state) {
...
static void __keyboard_modifiers(void *data, struct wl_keyboard *wl_keyboard, uint32_t serial, uint32_t mods_depressed,	uint32_t mods_latched, uint32_t mods_locked, uint32_t group) {
...
static void __keyboard_repeat_info(void *data, struct wl_keyboard *wl_keyboard, int32_t rate, int32_t delay) {
...
static void __pointer_enter(void *data, struct wl_pointer *wl_pointer, uint32_t serial, struct wl_surface *surface, wl_fixed_t surface_x, wl_fixed_t surface_y) {
    // fprintf(stderr, "__pointer_enter: %d, %d\n", px(surface_x), px(surface_y));
}

static void __pointer_leave(void *data, struct wl_pointer *wl_pointer, uint32_t serial,	struct wl_surface *surface) {
    // fprintf(stderr, "__pointer_leave\n");
}

static void __pointer_motion(void *data, struct wl_pointer *wl_pointer,	uint32_t time, wl_fixed_t surface_x, wl_fixed_t surface_y) {
    // fprintf(stderr, "__pointer_motion\n");
}

static void __pointer_button(void *data, struct wl_pointer *wl_pointer,	uint32_t serial, uint32_t time,	uint32_t button, uint32_t state) {
...
static void __pointer_axis(void *data, struct wl_pointer *wl_pointer, uint32_t time, uint32_t axis,	wl_fixed_t value) {
    int x = 0;
    int y = 0;
...
static void __pointer_frame(void *data,	struct wl_pointer *wl_pointer) {
    // fprintf(stderr, "__pointer_frame\n");
}

static void __pointer_axis_source(void *data, struct wl_pointer *wl_pointer, uint32_t axis_source) {
...
static void __pointer_axis_stop(void *data,	struct wl_pointer *wl_pointer, uint32_t time, uint32_t axis) {
    fprintf(stderr, "__pointer_axis_stop\n");
}

static void __pointer_axis_discrete(void *data, struct wl_pointer *wl_pointer, uint32_t axis, int32_t discrete) {
...
recreate_buffer_cb_type initialize_window(void (*draw_cb_arg)(struct bitmap *buf), void (*key_cb_arg)(xkb_keysym_t key), void (*mouse_cb_arg)(uint32_t mouse_event, uint32_t x, uint32_t y, const struct scroll *scroll)) {
    draw_cb = draw_cb_arg;
    key_cb = key_cb_arg;
